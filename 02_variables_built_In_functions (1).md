...
<sub>
<small>Notes by Waqas Khan</small>
</sub>
...
```py
first_name, last_name, country, age, is_married = 'Waqas', 'Khan', 'Pakistan', 250, True
...
# str to list
first_name = 'Waqas'
print(first_name)               # 'Waqas'
first_name_to_list = list(first_name)
print(first_name_to_list)            # ['W', 'a', 'q', 'a', 's']
```
